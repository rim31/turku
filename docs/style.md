...
.btn-outline-primary.focus {
  box-shadow: 0 0 0 0 rgba(15, 185, 177,0.5);
}
...
.custom-select:focus {
  border-color: rgba(50, 151, 211, 0.25);
  outline: 0;
  box-shadow: inset 0 1px 2px rgba(34, 42, 66, 0.075), 0 0 0 0 #26de81;
}
...
.btn-primary {
  background: #26de81;
  background-image: -webkit-linear-gradient(to bottom left, #26de81, #ba54f5, #26de81);
  background-image: -o-linear-gradient(to bottom left, #26de81, #ba54f5, #26de81);
  background-image: -moz-linear-gradient(to bottom left, #26de81, #ba54f5, #26de81);
  background-image: linear-gradient(to bottom left, #26de81, #ba54f5, #26de81);
  background-size: 210% 210%;
  background-position: top right;
  background-color: #26de81;
  transition: all 0.15s ease;
...
.btn-primary.active:hover {
  ...
  background-image: linear-gradient(to bottom left, #26de81, #ba54f5, #26de81) !important;
  background-image: -webkit-linear-gradient(to bottom left, #26de81, #ba54f5, #26de81) !important;
  background-image: -o-linear-gradient(to bottom left, #26de81, #ba54f5, #26de81) !important;
  background-image: -moz-linear-gradient(to bottom left, #26de81, #ba54f5, #26de81) !important;
  color: #ffffff;
  box-shadow: none;
}
...
.off-canvas-sidebar {
  background: #ba54f5;
  background: -webkit-linear-gradient(0deg, #ba54f5 0%, #26de81 100%);
  background: -o-linear-gradient(0deg, #ba54f5 0%, #26de81 100%);
  background: -moz-linear-gradient(0deg, #ba54f5 0%, #26de81 100%);
  background: linear-gradient(0deg, #ba54f5 0%, #26de81 100%);
...
.map .overlay {
  width: 344px;
  height: 599px;
  background: url(map.png) -344px top no-repeat;
  position: absolute;
  top: 0;
  left: 0;
  z-index: 1;
